...
const telegramFeatures = [
  { icon: '🤖', label: 'Interface animée', explanation: "Une interface moderne et animée pour une expérience utilisateur engageante et agréable." },
  { icon: '🔄', label: 'Google Tools', explanation: "Connexion et automatisation avec Google Sheets, Drive, Calendar, etc. pour booster la productivité." },
  { icon: '⚡', label: 'Automatisation', explanation: "Des tâches répétitives gérées automatiquement pour gagner du temps au quotidien." },
  { icon: '🎨', label: 'Design moderne', explanation: "Un look épuré, inspiré des tendances tech et green, pour valoriser l'image de marque." },
  { icon: '🔔', label: 'Alertes smart', explanation: "Des notifications intelligentes et personnalisées pour ne rien rater d'important." },
];

const n8nProjects = [
  { icon: '🎬', title: 'AI Video Factory', desc: "Publie automatiquement des vidéos sur TikTok, Instagram, YouTube, Facebook et LinkedIn à partir d'idées dans Google Sheets." },
  { icon: '📧', title: 'Assistant email intelligent', desc: "Tri, réponse automatique et classement des mails Gmail." },
  { icon: '🔎', title: 'Scraping réseaux sociaux', desc: "Veille automatique de profils Instagram ou LinkedIn, stockage dans Google Sheets." },
  { icon: '📰', title: 'Newsletter personnalisée', desc: "Génération et envoi automatique de newsletters avec OpenAI et Gmail." },
  { icon: '🔄', title: 'Sync bases de données', desc: "Synchronisation entre Airtable, Notion et Google Sheets." },
  { icon: '🔔', title: 'Alertes Slack/Discord', desc: "Notifications sur nouveaux leads ou événements importants." },
  { icon: '📅', title: "Gestion d'événements", desc: "Inscriptions Typeform → Airtable → Trello + email de confirmation." },
  { icon: '🤖', title: 'Chatbots IA', desc: "Création de chatbots pour sites web ou Telegram." },
  { icon: '💾', title: 'Backup GitHub', desc: "Sauvegarde automatique de workflows vers GitHub." },
  { icon: '📊', title: 'Conversion de fichiers', desc: "Convertit des fichiers (ex : JSON → Excel) et les envoie par email." },
];
